...
ALLOWED_HOSTS = ['boutiqado.herokuapp.com', 'localhost']
...
if 'USE_AWS' in os.environ:
    ...
    AWS_ACCESS_KEY_ID = os.envireon.get('AWS_ACCESS_KEY_ID')
    AWS_SECRET_ACCESS_KEY = os.envireon.get('AWS_SECRET_ACCESS_KEY')
